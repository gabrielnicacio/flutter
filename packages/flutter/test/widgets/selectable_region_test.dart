...
void main() {
  ...
  group('SelectableRegion', () {
    testWidgets('mouse selection single click sends correct events',
    ...
    testWidgets('mouse double click sends select-word event',
        (WidgetTester tester) async {
      final UniqueKey spy = UniqueKey();
      final FocusNode focusNode = FocusNode();
      addTearDown(focusNode.dispose);
    ...
    testWidgets('Does not crash when using Navigator pages',
        (WidgetTester tester) async {
    ...
    testWidgets('can draw handles when they are at rect boundaries',
        (WidgetTester tester) async {
      final UniqueKey spy = UniqueKey();
      final FocusNode focusNode = FocusNode();
      addTearDown(focusNode.dispose);
    ...
    testWidgets('does not merge semantics node of the children',
        (WidgetTester tester) async {
    ...
    testWidgets('mouse single-click selection collapses the selection',
      ...
      expect((renderSelectionSpy.events[0] as SelectionEdgeUpdateEvent).type,
          SelectionEventType.startEdgeUpdate);
      expect(renderSelectionSpy.events[1], isA<SelectionEdgeUpdateEvent>());
      expect((renderSelectionSpy.events[1] as SelectionEdgeUpdateEvent).type,
          SelectionEventType.endEdgeUpdate);
    }, skip: kIsWeb); // https://github.com/flutter/flutter/issues/102410.

    testWidgets('touch long press sends select-word event',
        (WidgetTester tester) async {
      final UniqueKey spy = UniqueKey();
      final FocusNode focusNode = FocusNode();
      addTearDown(focusNode.dispose);
    ...
    testWidgets('touch long press and drag sends correct events',
        (WidgetTester tester) async {
      final UniqueKey spy = UniqueKey();
      final FocusNode focusNode = FocusNode();
      addTearDown(focusNode.dispose);
    ...
    testWidgets('mouse long press does not send select-word event',
        (WidgetTester tester) async {
      final UniqueKey spy = UniqueKey();
      final FocusNode focusNode = FocusNode();
      addTearDown(focusNode.dispose);
  ...
  group('SelectionArea integration', () {
    ...
    testWidgets('mouse can select single text on mobile platforms',
        (WidgetTester tester) async {
      final FocusNode focusNode = FocusNode();
      addTearDown(focusNode.dispose);
    ...
    testWidgets('mouse can select word-by-word on double click drag',
        (WidgetTester tester) async {
      final FocusNode focusNode = FocusNode();
      addTearDown(focusNode.dispose);
    ...
    testWidgets('mouse can select multiple widgets',
        (WidgetTester tester) async {
      final FocusNode focusNode = FocusNode();
      addTearDown(focusNode.dispose);
    ...
    testWidgets(
        'collapsing selection should clear selection of all other selectables',
        (WidgetTester tester) async {
      final FocusNode focusNode = FocusNode();
      addTearDown(focusNode.dispose);
      ...
      await tester.pumpAndSettle();
      expect(
          paragraph1.selections[0], const TextSelection.collapsed(offset: 2));
      ...
      expect(
          paragraph2.selections[0], const TextSelection.collapsed(offset: 5));
      ...
      expect(paragraph2.selections.isEmpty, isTrue);
      expect(
          paragraph3.selections[0], const TextSelection.collapsed(offset: 13));
    });

    testWidgets('mouse can work with disabled container',
        (WidgetTester tester) async {
      final FocusNode focusNode = FocusNode();
      addTearDown(focusNode.dispose);
        ...
        List<FadeTransition> transitions = find
            .descendant(
              of: find.byWidgetPredicate((Widget w) =>
                  '${w.runtimeType}' == '_SelectionHandleOverlay'),
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        expect(paragraph.selections.isEmpty, isFalse);
        expect(
            paragraph.selections[0], const TextSelection.collapsed(offset: 9));
        expect(find.byKey(toolbarKey), findsNothing);
      },
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        final RenderParagraph paragraph = tester.renderObject<RenderParagraph>(
            find.descendant(
                of: find.text('How are you'), matching: find.byType(RichText)));
        final TestGesture primaryMouseButtonGesture =
        ...
        await primaryMouseButtonGesture
            .down(textOffsetToPosition(paragraph, 1));
        await tester.pump();
        ...
        expect(
            paragraph.selections[0], const TextSelection.collapsed(offset: 1));
        expect(find.byKey(toolbarKey), findsNothing);
      },
      variant: const TargetPlatformVariant(
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        expect(paragraph.selections.isEmpty, false);
        expect(
            paragraph.selections[0], const TextSelection.collapsed(offset: 2));
        ...
        expect(paragraph.selections.isEmpty, false);
        expect(
            paragraph.selections[0], const TextSelection.collapsed(offset: 6));
        ...
        await primaryMouseButtonGesture
            .down(textOffsetToPosition(paragraph, 0));
        await tester.pump();
        await primaryMouseButtonGesture
            .moveTo(textOffsetToPosition(paragraph, 5));
        await tester.pump();
        expect(paragraph.selections[0],
            const TextSelection(baseOffset: 0, extentOffset: 5));
        await primaryMouseButtonGesture.up();
        ...
        expect(paragraph.selections.isEmpty, false);
        expect(
            paragraph.selections[0], const TextSelection.collapsed(offset: 7));
        expect(find.byKey(toolbarKey), findsOneWidget);
    ...
    testWidgets('can copy a selection made with the mouse',
        (WidgetTester tester) async {
      final FocusNode focusNode = FocusNode();
      addTearDown(focusNode.dispose);
      ...
      (WidgetTester tester) async {
        ...
        final RenderParagraph innerParagraph =
            tester.renderObject<RenderParagraph>(find
                .descendant(
                    of: find.byKey(innerText), matching: find.byType(RichText))
                .first);
        final TestGesture gesture = await tester.startGesture(
            textOffsetToPosition(paragraph, 0),
            kind: PointerDeviceKind.mouse);
        ...
        await tester.pump();
        await gesture
            .moveTo(textOffsetToPosition(innerParagraph, 2)); // on `Good`.
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        final Offset gestureOffset =
            tester.getCenter(find.byKey(flutterLogo).first);
    ...
    testWidgets('mouse can select across bidi text',
        (WidgetTester tester) async {
      final FocusNode focusNode = FocusNode();
      addTearDown(focusNode.dispose);
    ...
    testWidgets('can drag end handle when not covering entire screen',
        (WidgetTester tester) async {
    ...
    testWidgets('can use keyboard to directionally extend selection',
        (WidgetTester tester) async {
      final FocusNode focusNode = FocusNode();
      addTearDown(focusNode.dispose);
